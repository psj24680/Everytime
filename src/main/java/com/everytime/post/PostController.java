...
public class PostController {
  ...
  public String myPostView(
    ...
    model.addAttribute("myPostList",
        postBO.getPostListByNickname((String) session.getAttribute("userNickname")));
  ...
  public String myCommentView(
      HttpSession session,
      Model model) {
    model.addAttribute("myCommentPostList", postBO
        .generateMyCommentViewPostListByNickname((String) session.getAttribute("userNickname")));
  ...
  public String myClippingView(
      HttpSession session,
      Model model) {
    model.addAttribute("myClippingList",
        postBO.generateMyClippingViewPostListByUserId((int) session.getAttribute("userId")));
