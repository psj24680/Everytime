...
public interface CommentCommentDAO {
  ...
  public int insertCommentComment(@Param("boardId") int boardId, @Param("postId") int postId,
      @Param("commentId") int commentId, @Param("nickname") String nickname,
      @Param("content") String content, @Param("anonymous") String anonymous);
  ...
  public List<CommentComment> selectCommentCommentListByNickname(String nickname);
