...
public class UserBO {
  ...
  public int addUser(String loginId, String password, String email, String nickname, String school,
      String schoolId) {
  ...
  public int updatePasswordByLoginIdAndPassword(String loginId, String currentPassword,
      String password) {
